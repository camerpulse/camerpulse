-- Add missing senator fields for enhanced functionality
...
SET 
  ...
  badges = CASE 
    WHEN average_rating >= 4 THEN ARRAY['High Performer', 'Civic Champion']
    WHEN average_rating >= 3 THEN ARRAY['Active Legislator']
    ELSE ARRAY['New Senator']
  END,
  education = '[
    {
