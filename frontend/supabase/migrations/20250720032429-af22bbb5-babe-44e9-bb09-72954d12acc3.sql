-- Phase 2: Enhanced Engagement Tools Migration (Fixed)
...
-- User achievements and certifications (Fixed - removed sample insert that had null user_id)
...
INSERT INTO public.civic_education_content (
  ...
  (
    ...
    'Democratic governance forms the foundation of modern civic participation. In Cameroon, the government operates through three main branches: Executive, Legislative, and Judicial. The President serves as the head of state and government, while the National Assembly and Senate form the bicameral legislature. Understanding these structures is crucial for effective civic participation.',
  ...
  (
    ...
    'Understanding your rights is essential for effective civic participation. This comprehensive guide covers constitutional rights, legal protections, and practical steps for seeking redress when rights are violated.',
  ...
  (
    ...
    'Local government is where citizens can have the most direct impact on their daily lives. This interactive course teaches you how to navigate municipal structures, participate in council meetings, and advocate for community issues.',
...
INSERT INTO public.civic_learning_paths (
  title, description, difficulty_level, estimated_duration_hours, learning_outcomes, content_sequence, is_certification_path
) VALUES
  (
