...
-- Insert Camer Logistics as a plugin (only if not exists)
...
WHERE NOT EXISTS (
  SELECT 1 FROM public.plugin_registry WHERE plugin_name = 'camer-logistics'
);