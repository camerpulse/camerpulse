...
('Award Voting Open', 'voting_opens', 'fan', 'email', '{}', true, 1, 0),
...
('Ticket Purchase Confirmation', 'ticket_purchased', 'event_attendee', 'email', '{}', true, 1, 0),
('Event Reminder 24h', 'event_reminder_24h', 'event_attendee', 'email', '{}', true, 1, 1440),
('Event Cancellation Notice', 'event_cancelled', 'event_attendee', 'email', '{}', true, 1, 0);

-- Insert corresponding notification templates with correct column names
