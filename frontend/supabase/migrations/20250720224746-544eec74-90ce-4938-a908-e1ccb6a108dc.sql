-- Create ENUM types for grants and rewards system
CREATE TYPE public.grant_status AS ENUM ('draft', 'open', 'closed', 'suspended');
CREATE TYPE public.application_status AS ENUM ('draft', 'submitted', 'under_review', 'approved', 'rejected', 'awarded');
...
(
  ...
  'Full scholarships for students who demonstrate exceptional understanding of Cameroon\'s constitution and civic principles.',
  'education',
