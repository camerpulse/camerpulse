-- Schools Directory Tables
CREATE TABLE public.schools (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  name TEXT NOT NULL,
  school_type TEXT NOT NULL DEFAULT 'primary', -- primary, secondary, university, technical, nursery
  ...
  verification_type TEXT, -- government, parent_community, self_reported
  features TEXT[] DEFAULT ARRAY[]::TEXT[], -- library, computer_lab, sports_field, etc
  tuition_range TEXT, -- free, low, medium, high
  languages TEXT[] DEFAULT ARRAY[]::TEXT[], -- french, english, local_languages
...
CREATE TABLE public.village_campaigns (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  village_id UUID NOT NULL,
  title TEXT NOT NULL,
  description TEXT NOT NULL,
...
CREATE POLICY "Users can update schools they created" ON public.schools FOR UPDATE USING (auth.uid() = created_by);
...
ALTER TABLE public.schools ADD CONSTRAINT schools_created_by_fkey FOREIGN KEY (created_by) REFERENCES auth.users (id);
