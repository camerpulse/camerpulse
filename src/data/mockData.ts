...
export const mockMarketplaceVendors = [
  {
    id: '1',
    user_id: '4',
    vendor_id: 'CM-VEN-2024-001',
    business_name: 'TechHub Cameroon',
    description: 'Leading electronics and tech accessories store serving Central and West Africa since 2018. Authorized dealer for Samsung, Apple, HP, and more.',
    verification_status: 'verified',
    rating: 4.8,
    total_sales: 2847,
    location: 'Akwa, Douala, Littoral',
    phone: '+237 677 89 12 34',
    email: 'sales@techhub.cm',
    business_hours: 'Mon-Sat: 8AM-7PM',
    established_year: 2018,
    specialties: ['Electronics', 'Mobile Phones', 'Computers', 'Gaming'],
    shipping_regions: ['Douala', 'Yaoundé', 'Bafoussam', 'Bamenda'],
    profile: {
      username: 'techhub_cm',
  ...
  },
  {
    id: '2',
    user_id: '5',
    vendor_id: 'CM-VEN-2024-002',
    business_name: 'Mama Africa Crafts & Heritage',
    description: 'Authentic African crafts, traditional clothing, and cultural artifacts. Preserving Cameroonian heritage through quality handmade products.',
    verification_status: 'verified',
    rating: 4.9,
    total_sales: 1653,
    location: 'Melen, Yaoundé, Centre',
    phone: '+237 695 45 67 89',
    email: 'info@mamaafricacrafts.cm',
    business_hours: 'Mon-Fri: 9AM-6PM, Sat: 9AM-4PM',
    established_year: 2015,
    specialties: ['Traditional Clothing', 'Handicrafts', 'Art', 'Cultural Items'],
    shipping_regions: ['Yaoundé', 'Douala', 'Bertoua', 'Ngaoundéré'],
    profile: {
      username: 'mama_africa_heritage',
      display_name: 'Aminata Kone-Bessala',
  ...
  },
  {
    id: '3',
    user_id: '3',
    vendor_id: 'CM-VEN-2024-003',
    business_name: 'Green Valley Organic Farms',
    description: 'Certified organic produce from the fertile highlands of Northwest Cameroon. Farm-to-table freshness with sustainable farming practices.',
    verification_status: 'verified',
    rating: 4.6,
    total_sales: 892,
    location: 'Santa, Bamenda, Northwest',
    phone: '+237 651 23 45 67',
    email: 'orders@greenvalleyorganic.cm',
    business_hours: 'Daily: 6AM-6PM',
    established_year: 2020,
    specialties: ['Organic Vegetables', 'Coffee', 'Honey', 'Spices'],
    shipping_regions: ['Bamenda', 'Bafoussam', 'Douala', 'Yaoundé'],
    profile: {
      username: 'green_valley_farms',
      display_name: 'Marie Nkomo Fru',
  ...
  },
  {
    id: '4',
    user_id: '6',
    vendor_id: 'CM-VEN-2024-004',
    business_name: 'Urban Style Fashion House',
    description: 'Contemporary African fashion blending traditional patterns with modern designs. Custom tailoring and ready-to-wear collections.',
    verification_status: 'verified',
    rating: 4.7,
    total_sales: 1456,
    location: 'Bonapriso, Douala, Littoral',
    phone: '+237 678 90 12 34',
    email: 'hello@urbanstylecm.com',
    business_hours: 'Tue-Sun: 10AM-8PM',
    established_year: 2019,
    specialties: ['Fashion Design', 'Custom Tailoring', 'Ankara Clothing', 'Accessories'],
    shipping_regions: ['Douala', 'Yaoundé', 'Limbe', 'Kribi'],
    profile: {
      username: 'urban_style_cm',
  ...
  },
  {
    id: '5',
    user_id: '7',
    vendor_id: 'CM-VEN-2024-005',
    business_name: 'Master Artisan Workshop',
    description: 'Handcrafted furniture and home decor using locally sourced wood. Three generations of woodworking expertise in traditional and modern designs.',
    verification_status: 'verified',
    rating: 4.8,
    total_sales: 634,
    location: 'Bafoussam, West Region',
    phone: '+237 689 12 34 56',
    email: 'workshop@masterartisan.cm',
    business_hours: 'Mon-Sat: 7AM-5PM',
    established_year: 1987,
    specialties: ['Custom Furniture', 'Wood Carving', 'Home Decor', 'Restoration'],
    shipping_regions: ['Bafoussam', 'Douala', 'Yaoundé'],
    profile: {
      username: 'master_artisan_workshop',
  ...
  },
  {
    id: '6',
    user_id: '8',
    vendor_id: 'CM-VEN-2024-006',
    business_name: 'Natural Wellness & Beauty Co.',
    description: 'Premium natural skincare and wellness products made from indigenous Cameroonian plants. Certified organic and cruelty-free.',
    verification_status: 'verified',
    rating: 4.9,
    total_sales: 2156,
    location: 'Bastos, Yaoundé, Centre',
    phone: '+237 672 34 56 78',
    email: 'care@naturalwellness.cm',
    business_hours: 'Mon-Sat: 8AM-7PM',
    established_year: 2017,
    specialties: ['Natural Skincare', 'Essential Oils', 'Wellness Products', 'Beauty'],
    shipping_regions: ['Yaoundé', 'Douala', 'Garoua', 'Maroua'],
    profile: {
      username: 'natural_wellness_co',
