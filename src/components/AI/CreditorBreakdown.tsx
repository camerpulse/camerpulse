...
export const CreditorBreakdown = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'restructured': return 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300';
      case 'defaulted': return 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300';
