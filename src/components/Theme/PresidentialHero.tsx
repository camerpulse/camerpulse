...
export const PresidentialHero: React.FC<PresidentialHeroProps> = ({ className }) => {
  return (
    <section className={cn(
      "relative overflow-hidden bg-gradient-to-br from-background via-card to-background",
          ...
          <defs>
            <pattern id="presidential-pattern" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
              <path d="M10 2 L12 8 L18 8 L13 12 L15 18 L10 14 L5 18 L7 12 L2 8 L8 8 Z" 
                    fill="currentColor" className="text-primary" opacity="0.3"/>
            </pattern>
          </defs>
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex justify-center mb-8">
            <div className={cn(
              ...
              <div className="absolute -inset-8 rounded-full border border-secondary/15 animate-pulse" style={{ animationDelay: '1s' }} />
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h1 className={cn(
              "text-5xl md:text-6xl lg:text-7xl font-bold text-foreground",
