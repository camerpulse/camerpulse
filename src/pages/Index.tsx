    ...
    <AppLayout>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-40 right-20 w-48 h-48 bg-accent/10 rounded-full blur-3xl animate-pulse" />
          <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-secondary/10 rounded-full blur-2xl animate-pulse" />
        </div>

        <div className="relative container mx-auto px-4 py-16 text-center">
          {/* Badge */}
          <Badge variant="secondary" className="mb-8 text-base font-medium px-6 py-3 animate-fade-in shadow-md">
          ...
          <div className="mb-8 animate-fade-in">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold font-playfair mb-4 leading-tight">
              <span className="block bg-gradient-to-r from-primary via-accent to-secondary bg-clip-text text-transparent">
                CamerPulse
              </span>
            </h1>
            <p className="text-2xl md:text-4xl lg:text-5xl font-grotesk font-light text-muted-foreground">
              Democracy in <span className="text-primary font-medium">Your Hands</span>
            </p>
          </div>
          
          {/* Revolutionary Description */}
          <p className="text-lg md:text-xl text-muted-foreground mb-12 max-w-4xl mx-auto leading-relaxed animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-fade-in">
            <Button asChild size="lg" className="bg-gradient-to-r from-primary to-primary-glow hover:shadow-glow transition-all duration-300 px-8 py-6 text-lg">
              <Link to="/auth">
                <Play className="h-5 w-5 mr-2" />
                Start Your Journey
              </Link>
            </Button>
            <Button asChild variant="outline" size="lg" className="px-8 py-6 text-lg hover:bg-muted/50 transition-all">
