        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <Button className="w-full" onClick={() => navigateTo('/diaspora/donations')}>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <Button variant="outline" className="w-full" onClick={() => navigateTo('/diaspora/events')}>
                View Events
              </Button>
            </CardContent>
          </Card>
        ...
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <div className="flex gap-4 justify-center">
              <Button size="lg" onClick={() => navigateTo('/diaspora/auth')}>
                Create Diaspora Profile
              </Button>
              <Button variant="outline" size="lg" onClick={() => navigateTo('/diaspora/impact')}>
                Learn More
              </Button>
            </div>
          </CardContent>
