        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-bold text-foreground">CamerPulse</h1>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center space-y-6 sm:space-y-8 mb-12 sm:mb-16">
            <div className="space-y-4">
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
                ...
                <span className="text-primary block sm:inline"> Cameroon</span>
              </h2>
            ...
            {/* Stats Grid */}
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-4xl mx-auto mt-8">
          ...
          <section className="mb-12 sm:mb-16">
            <div className="text-center mb-8 sm:mb-12">
              <h3 className="text-2xl sm:text-3xl font-bold mb-4">Explore CamerPulse</h3>
              <p className="text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto">
                Comprehensive tools for civic engagement and community building
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {features.map((feature, index) => (
                <Card key={index} className="hover:shadow-xl transition-all duration-300 group hover:scale-105 h-full">
                  <CardHeader className="pb-4">
          ...
          <section className="mb-12 sm:mb-16">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 space-y-4 sm:space-y-0">
              <div>
                <h3 className="text-2xl sm:text-3xl font-bold">Latest Updates</h3>
          ...
          <section className="text-center">
            <Card className="max-w-4xl mx-auto bg-gradient-to-r from-primary/10 to-secondary/10 border-primary/20 shadow-xl">
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div className="flex items-center gap-3 p-4 bg-background/50 rounded-lg">
                    <Vote className="h-6 w-6 sm:h-8 sm:w-8 text-blue-500 flex-shrink-0" />
                    <div className="text-left">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><Link to="/villages" className="hover:text-foreground transition-colors">Village Registry</Link></li>
                <li><Link to="/petitions" className="hover:text-foreground transition-colors">Petitions</Link></li>
                <li><Link to="/civic-education" className="hover:text-foreground transition-colors">Civic Education</Link></li>
                <li><Link to="/transparency" className="hover:text-foreground transition-colors">Transparency Portal</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-medium mb-3">Services</h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><PluginAwareLink pluginName="camer-logistics" to="/logistics" className="hover:text-foreground transition-colors">Logistics Platform</PluginAwareLink></li>
                <li><Link to="/jobs" className="hover:text-foreground transition-colors">Job Portal</Link></li>
                <li><Link to="/directory" className="hover:text-foreground transition-colors">Services Directory</Link></li>
              </ul>
            </div>
            <div>
