-- Phase 2: Payment Integration & Wallet - Essential tables only
...
-- Update tender_payments to support enum status (convert text to enum)
ALTER TABLE public.tender_payments 
ALTER COLUMN payment_status TYPE tender_payment_status 
USING payment_status::tender_payment_status;