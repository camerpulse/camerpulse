-- Fix critical PII exposure vulnerabilities with correct column names
...
-- Public can see basic info but not contact details
...
CREATE POLICY "Company owners can manage profile"
  ON public.delivery_company_profiles
  FOR ALL
...
CREATE POLICY "Public can view scholarship opportunities"
