-- Phase 1: Performance Optimization & Enhanced Fraud Protection (Final Fix)
...
-- 2. Enhanced Fraud Detection Function
...
-- 4. Poll Performance Analytics Function
...
-- Create indexes for performance (only on tables, not views)
...
CREATE INDEX IF NOT EXISTS idx_poll_options_poll_id ON public.poll_options(poll_id, option_order);