-- Switch to public-namespaced backup tables to avoid schema resolution issues
CREATE TABLE IF NOT EXISTS public.cleanup_backup__cleanup_runs (
...
CREATE TABLE IF NOT EXISTS public.cleanup_backup__cleanup_reports (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  run_id uuid NOT NULL REFERENCES public.cleanup_backup__cleanup_runs(id) ON DELETE CASCADE,
