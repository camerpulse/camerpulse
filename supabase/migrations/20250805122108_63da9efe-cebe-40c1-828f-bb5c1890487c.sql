-- Fix RLS policies for existing tables that have RLS enabled but no policies

-- 1. Fix politicians table - make user_id NOT NULL and add proper policies
...
-- 4. Fix security_audit_logs table
...
-- 7. Add session timeout configuration table
