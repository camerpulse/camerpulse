-- Phase 1: Performance Optimization & Enhanced Fraud Protection
...
ALTER TABLE public.poll_regional_results REPLICA IDENTITY FULL;
ALTER TABLE public.poll_fraud_alerts REPLICA IDENTITY FULL;

-- Add to realtime publication
ALTER PUBLICATION supabase_realtime ADD TABLE public.poll_regional_results;
