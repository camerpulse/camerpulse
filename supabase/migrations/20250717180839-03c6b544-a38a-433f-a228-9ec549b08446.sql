-- Cross-Platform Stats Sync, AI Copyright Detection & Notification System
...
CREATE INDEX idx_platform_connections_artist ON public.artist_platform_connections(artist_id);
CREATE INDEX idx_platform_connections_user ON public.artist_platform_connections(user_id);
CREATE INDEX idx_platform_performance_connection ON public.platform_performance_data(connection_id);
CREATE INDEX idx_platform_performance_date ON public.platform_performance_data(date_recorded);
CREATE INDEX idx_fingerprints_track ON public.audio_fingerprints(track_id);
CREATE INDEX idx_violations_track ON public.copyright_violations(track_id);
CREATE INDEX idx_violations_status ON public.copyright_violations(status);
CREATE INDEX idx_notifications_artist ON public.artist_notifications(artist_id);
CREATE INDEX idx_notifications_user ON public.artist_notifications(user_id);
CREATE INDEX idx_notifications_unread ON public.artist_notifications(is_read) WHERE is_read = false;
CREATE INDEX idx_milestones_artist ON public.performance_milestones(artist_id);
