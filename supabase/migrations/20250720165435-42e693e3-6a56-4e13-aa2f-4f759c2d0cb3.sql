...
INSERT INTO public.budget_explorer (
  project_name,
  ministry_department,
  sector,
  region,
...
-- Justice Projects
('Court Infrastructure Renovation', 'MINJUSTICE', 'Justice', 'Southwest', 2024, 12000000000, 8400000000, 70.0, 72, 'executing', 'Renovation of court buildings and facilities', 15000, 10500),
('Legal Aid Program', 'MINJUSTICE', 'Justice', 'Centre', 2024, 5000000000, 4500000000, 90.0, 85, 'completed', 'Provision of legal aid services to citizens', 50000, 45000),

-- Communication Projects
('Digital Infrastructure Rollout', 'MINCOM', 'Communication', 'All Regions', 2024, 40000000000, 12000000000, 30.0, 52, 'executing', 'Rollout of digital communication infrastructure', 5000000, 1500000),

-- Public Works
('Water Supply Systems', 'MINEE', 'Public Works', 'East', 2024, 30000000000, 21000000000, 70.0, 75, 'executing', 'Development of water supply systems', 300000, 210000),
('Urban Planning Initiative', 'MINDUH', 'Public Works', 'Littoral', 2024, 18000000000, 5400000000, 30.0, 48, 'executing', 'Urban planning and development projects', 100000, 30000);