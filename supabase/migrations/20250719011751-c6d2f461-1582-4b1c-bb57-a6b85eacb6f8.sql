...
SELECT 
  ...
  END,
  CASE 
    WHEN v.village_name IN ('Bafut', 'Kom (Laikom)', 'Bali Nyonga', 'Nso (Kumbo)', 'Ndu', 'Babanki Tungo') THEN 'Fon'
  ...
  LOWER(REPLACE(v.village_name, ' ', '.')) || '@traditional.cm',
  '2020-01-01'::date,
  true,
  'traditional'
...
-- Update villages with development and infrastructure scores
...
-- Mark all imported data as seeded content with system contributions
