-- PulseNotify v3.5: Comprehensive Notification System Upgrade
...
CREATE INDEX idx_user_notifications_unread ON public.user_notifications(user_id, is_read, created_at DESC) WHERE NOT is_read;
...
CREATE INDEX idx_user_notifications_geo ON public.user_notifications(geo_targeted, target_regions) WHERE geo_targeted;
