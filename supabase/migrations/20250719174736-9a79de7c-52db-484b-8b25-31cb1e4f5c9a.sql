-- Insert notification flow configurations with correct column names
...
('Artist Submission Received', 'artist_submission', 'artist', 'email', '{}', true, 1, 0),
('Artist Application Approved', 'artist_approved', 'artist', 'email', '{}', true, 1, 0),
('Artist Profile Rejected', 'artist_rejected', 'artist', 'email', '{}', true, 1, 0),
('New Follower Alert', 'new_follower', 'artist', 'in_app', '{}', true, 2, 0),
('Song Upload Confirmation', 'song_uploaded', 'artist', 'email', '{}', true, 1, 0),
('New Song Fan Notification', 'song_uploaded_notify_fans', 'fan', 'email', '{}', true, 1, 0),
('Stream Milestone Alert', 'stream_milestone', 'artist', 'in_app', '{}', true, 2, 0),
('Song Added to Playlist', 'song_added_to_playlist', 'artist', 'in_app', '{}', true, 2, 0),
('Award Nomination - Artist', 'award_nomination_artist', 'artist', 'email', '{}', true, 1, 0),
('Award Nomination - Fan Alert', 'award_nomination_notify_fans', 'fan', 'email', '{}', true, 1, 0),
('Award Voting Open', 'award_voting_open', 'public', 'email', '{}', true, 1, 0),
('Award Voting Closed', 'award_voting_close', 'artist', 'in_app', '{}', true, 2, 0),
('Award Winner Announcement', 'award_winner_announcement', 'artist', 'email', '{}', true, 1, 0),
('Event Published Confirmation', 'event_published', 'artist', 'email', '{}', true, 1, 0),
('New Event Fan Notification', 'event_published_notify_fans', 'fan', 'email', '{}', true, 1, 0),
('Ticket Purchase Confirmation', 'ticket_purchase', 'buyer', 'email', '{}', true, 1, 0),
('Event Reminder 24h', 'event_reminder_24h', 'buyer', 'email', '{}', true, 1, 1440),
('Event Replay Available', 'event_replay_available', 'attendee', 'email', '{}', true, 2, 0),
('Event Cancellation Notice', 'event_canceled', 'buyer', 'email', '{}', true, 1, 0),
('Badge Awarded', 'badge_awarded', 'artist', 'in_app', '{}', true, 2, 0);
