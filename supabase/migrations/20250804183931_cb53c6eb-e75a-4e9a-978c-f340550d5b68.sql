-- Fix Critical Data Conflicts for Production Readiness
...
CREATE POLICY "Super admins can manage all admin access"
...
CREATE POLICY "Admins can manage all politician data"
ON public.authoritative_politicians
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::app_role));
