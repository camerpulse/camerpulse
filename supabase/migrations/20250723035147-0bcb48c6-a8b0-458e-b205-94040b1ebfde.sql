-- Phase 1: CamerTenders Monetization Foundation & Core Billing (Corrected)
...
BEGIN
  ...
  -- Check company exists and is active (using correct column names)
  ...
  -- All checks passed - use company_name from the correct column
  RETURN jsonb_build_object(
    'eligible', true,
